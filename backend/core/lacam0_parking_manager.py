# core/lacam0_parking_manager.py
...
class LaCAM0ParkingManager(ParkingManager):
    """
    LaCAM0-specific parking manager.
    ...
    shared physical exit cell — a requirement of the LaCAM0 solver.
    ...
    def assign_goal(self, car, current_time) -> Optional[Position]:
        ...
        if car.intent == "EXIT":
            ...
            # Fallback (no ghost manager): revert to nearest exit cell
